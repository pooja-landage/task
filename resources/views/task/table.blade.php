        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            @foreach( $tasks as $task )
                                <li class="list-group-item" data-task-id="{{ $task->id }}" data-project-id="{{ $task->project ? $task->project->id : '' }}">
                                    <div class="row">
                                        ...
                                        <div class="col-auto"><a class="btn btn-info text-white" href="{{ route('task.edit', ['id' => $task->id]) }}">Edit</a></div>
                                        <div class="col-auto">
                    ...
                    @else
                        <p>There is no tasks yet, <a href="{{ route('task.create') }}">Create the first one.</a></p>
                    @endif
                </div>
            </div>
        </div>
